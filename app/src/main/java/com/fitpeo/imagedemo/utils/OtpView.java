...
public class OtpView extends AppCompatEditText {
    ...
    private OnOtpCompletionListeners onOtpCompletionListener;
    ...
    public void setOtpCompletionListener(OnOtpCompletionListeners otpCompletionListener) {
